...
export default class DotMap extends Chart {
    ...
    constructor(container, dataStore, title, bboxUsa){

        super(container);

        // let boundaries = { values: bbox };
        let boundaries = {
            values: {
                minX: bboxUsa.calculated[0],
                minY: bboxUsa.calculated[1],
                maxX: bboxUsa.calculated[2],
                maxY: bboxUsa.calculated[3]
            }
        };
